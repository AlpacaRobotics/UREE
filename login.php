...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT index_reg, nombre, contrasena FROM Usuarios WHERE nombre = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) > 0){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $index_reg, $username, $hashed_password);
                    ...
                    $username_err = "No se ha encontrado una cuenta con ese nombre de usuario.";
                }
            } else{
                echo "Ha ocurrido un error con el inicio de sesión. Por favor intentelo nuevamente mas tarde";
            }
        }
